...
-->
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <!-- .row -->
                <div class="row">
                    <form action="profile.php" class="container" method="post">
                    <div class="col-md-3 border-right">
                        <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img style="border-radius:50%; margin-top:24px;" class="rounded-circle mt-5" src="./images/users/user_5.jpg" width="200px;">
                            <p style="font-size:24px; font-weight:bold;"><?php echo $user_name; ?></p>
                            <span style="color:gray; font-size:16px;"><?php echo $user_email; ?></span>
                        </div>
                    </div>
...
<!--                                            <h4 class="text-right">Profile Settings</h4>-->
                            ...
                            <div class="row mt-3">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="user_name" placeholder="" value="<?php echo $user_name; ?>">
                                </div>
                            </div>
                            <div class="row mt-2">
                                <div class="col-md-6">
                                    <label class="labels">First Name</label>
                                    <input type="text" class="form-control" name="firstname" placeholder="first name" value="<?php echo $user_firstname; ?>">
                                </div>
                                <div class="col-md-6">
                                    <label class="labels">Last Name</label>
                                    <input type="text" class="form-control" name="lastname" value="<?php echo $user_lastname; ?>" placeholder="surname">
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-md-12">
                                    <label class="labels">Phone Number</label>
                                    <input type="phone" class="form-control" name="phone" placeholder="enter phone number" value="<?php echo $user_phone; ?>">
                                </div>
                                <div class="col-md-12">
                                    <label class="labels">Address</label>
                                    <input type="text" class="form-control" name="address" placeholder="enter address" value="<?php echo $user_address; ?>">
                                </div>
                                <div class="col-md-12">
                                    <label class="labels">Email </label>
                                    <input type="email" class="form-control" name="email" placeholder="enter email id" value="<?php echo $user_email; ?>">
                                </div>
                                <div class="col-md-12">
                                    <label class="labels">NID</label>
                                    <input type="nid" class="form-control" name="nid" placeholder="education" value="<?php echo $user_nid; ?>">
                                </div>
                                <div class="col-md-12">
                                    <label class="labels">Password</label>
                                    <input type="password" class="form-control" name="password" placeholder="education" value="<?php echo $user_password; ?>">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="p-3 py-5">
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" name="position" placeholder="experience" value="<?php echo $user_position; ?>">
                            </div> <br>
                            <div class="col-md-12">
                                <label class="labels">Status</label>
                                <input type="text" class="form-control" name="status" placeholder="additional details" value="<?php echo $user_status; ?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="mt-5 text-center" style="margin-top:16px;">
                            <button class="btn btn-lg btn-info" name="submit" type="submit">Save Profile</button>
                        </div>
                    </div>
                    </form>
                </div>
