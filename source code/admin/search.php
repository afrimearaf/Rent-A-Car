                        ...
                        <div class="white-box">
                            <?php
                                ...
                                if(isset($_POST['search_car'])){
                                    ...
                                    include "search/search_car.php";
                                }
                                if(isset($_POST['search_driver'])){

                                    include "search/search_driver.php";
                                }
                                if(isset($_POST['search_user'])){

                                    include "search/search_user.php";
                                }
                                if(isset($_POST['search_review'])){

                                    include "search/search_review.php";
                                }
                                if(isset($_POST['search_order'])){

                                    include "search/search_order.php";
                                }
                                if(isset($_POST['search_message'])){

                                    include "search/search_message.php";
                                }
