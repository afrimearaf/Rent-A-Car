...
<?php 
    ...
    if(isset($_GET['o_id'])){
        ...
        $query="UPDATE orders SET status='canceled' WHERE order_id= {$the_order_id} ";
        $cancel_order_query= mysqli_query($connection,$query);
        ...
        if(!$cancel_order_query){
            ...
            echo"<script>alert('You order has been requested for cancelation');
              ...
              <div class="container bootdey">
                <div class="row invoice row-printable">
                    <?php
                        ...
                        while($rows=mysqli_fetch_array($fetch_users)){
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12 mt-3">
                                            ...
                                            <div class="invoice-footer mt25">
                                                <p class="text-center">Record a payment on a customer invoice <button class="btn btn-info" onclick="window.print()"><i class="fa fa-print mr5"></i> Print</button></p>
                                            </div>
                                            <?php 
                                            ...
                                            <div class="invoice-footer mt25">
                                                <h3 class="text-center"><a class="btn btn-danger" href="order.php?o_id=<?php echo $order_id; ?>"><i class="fa fa-ban mr5"></i> Cancel Order</a></h3>
                                                <p class="text-center">You can cancel orders that haven't approved by the admin yet. After submitting a <strong>Request Cancellation</strong> you'll receive a confirmation message on the screen. And wait for the order to be canceled by <strong>Admin</strong></p>
                                            </div>
                                           <?php } ?>
                            ...
                            <div class="panel panel-default plain" id="dash_0">
                                <div class="panel-body p30">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="invoice-footer mt25">
                                                <h1 class="text-center">You dont have any order yet <a class="btn btn-danger" href="cart.php"><i class="fa fa-shopping-cart mr5"></i> Go To Cart</a></h1>
                                            </div>
                                        </div>
                                    <!-- col-lg-12 end here -->
                                    </div>
