...
-->
    ...
    <div class="best-features about-features">
      <div class="container">
        <form action="car_review.php" method="post">
            <div class="row">
                <div class="col-md-3">
                </div>
    ...
    if(isset($_GET['c_code'])){
        $the_car_code=$_GET['c_code'];
    }
      
    $sql="SELECT * FROM cars WHERE pcode = '$the_car_code'";
    $select_car_query = mysqli_query($connection, $sql); 
...
//        $pcode=$row['pcode'];
    ...
    if(isset($_POST['review'])){
        ...
        $review_car_query= mysqli_query($connection,$query2);
        ...
        $query_count= "UPDATE cars SET reviews = reviews+1 WHERE pcode = '$review_pcode'";
    ...
    ?>
                    ...
                    <h5 class="mt-3 mb-2 pl-2" style="font-weight:400;">Car Name</h5>
                    <span class="mb-4" style="padding:8px; border:2px solid #ddd; font-weight:300;"><?php  echo $name; ?></span>
                    <input type="hidden" class="" id="c_code" name="c_code" value="<?php  echo $the_car_code; ?>">
